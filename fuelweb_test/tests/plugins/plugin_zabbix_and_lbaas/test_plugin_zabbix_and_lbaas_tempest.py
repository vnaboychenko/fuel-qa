...
class ZabbixAndLbaasPlugins(TestBasic):
    ...
    @test(depends_on=[SetupEnvironment.prepare_slaves_5],
          groups=["deploy_zabbix_lbaas_ha_tempest"])
    @log_snapshot_after_test
    def deploy_zabbix_lbaas_ha_tempest(self):
        ...
        Scenario:
            ...
            12. Check zabbix service in pacemaker
            13. Check login to zabbix dashboard
            14. Run Tempest
        ...
        self.env.make_snapshot("deploy_zabbix_lbaas_ha_tempest") 
